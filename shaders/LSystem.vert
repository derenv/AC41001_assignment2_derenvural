...
//	vec4 diffuse = max(dot(N, light_dir), 0.0) * diffuse_colour; // standard diffuse calculation
	vec4 diffuse = abs(dot(N, light_dir)) * diffuse_colour;		 // Light both sides of a polygon
